...
We utilized PEcAn's sensitivity analysis to simulate the 4 genotypes.
The median run was used as wildtype, -1 SD for quantum efficiency represented high anthocyanin content, -1 SD for stomatal slope represented the increased leaf temperature genotype, and +1 SD for fine root to leaf ratio represented the dwarf genotype.
...
The resulting dataset contained mean summer NPP, the site ID, the 19 bioclimatic variables, mean solar radiation, and mean vapor pressure deficit, ecosystem, and genotype.
